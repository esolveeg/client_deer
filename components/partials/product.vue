<template>
    <div>
      ...
      <div class="pr-partial" v-else>
        <div class="img"  >
          <v-img min-height="200" @click.prevent="$router.push({name : `shop-id___${$i18n.locale}` , params : {id : product.id}})" :src="product.productImage"></v-img>
        ...
        <div class="meta text-center">
          <h2 class="product-title  pointer mb-2"  @click.prevent="$router.push({name : `shop-id___${$i18n.locale}` , params : {id : product.id}})">{{product.productName}}</h2>
          <div class="price">
